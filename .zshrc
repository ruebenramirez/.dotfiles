...
alias gpom='echo "git pull -r origin master" && git pull -r origin master'
alias gpomaster='echo "git pull -r origin master" && git pull -r origin master'
alias gpomain='echo "git pull -r origin main" && git pull -r origin main'
